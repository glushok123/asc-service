...
Route::group(['prefix' => 'category', 'as' => 'category.'], function () {
    Route::get('/{slug}', 'RepairCategoryController@show')->name('category.show');
});

Route::group(['prefix' => 'sub_category', 'as' => 'sub_category.'], function () {
    Route::get('/{slug_sub_category}', 'RepairCategoryController@showSubCategory')->name('sub_category.show');
    Route::get('/{slug_sub_category}/service/{slug_service}', 'RepairCategoryController@showSubCategoryService')->name('sub_category_service.show');
    Route::get('/{slug_sub_category}/brand/{slug_brand}', 'RepairCategoryController@showSubCategoryBrand')->name('sub_category_brand.show');
